...
<section className="product-card-container">
  ...
  <article className="product-detail-card">
    ...
    <p     clasName="product-card-body">Neither in the purchase nor at the time of departure Papapabit always shows you the real cost of what you are acquiring</p>
  </article>
  <article className="product-detail-card">
    <span  className="icon dollar"></span>
    <p     className="product-card-title">Compare currencies</p>
    <p     clasName="product-card-body">No more rumors, with Papapabit you will know the real value and you will compare all the coins</p>
  </article>
  <article className="product-detail-card">
    <span  className="icon check"></span>
    <p     className="product-card-title">Reliable information</p>
    <p     clasName="product-card-body">Our sources are 100% verified and we continue to audit their content as they are updated.</p>
  </article>
